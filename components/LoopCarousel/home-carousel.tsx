...
const HomeCarousel: React.FC<HomeCarouselProps> = ({
 ...
 <div className="grid grid-cols-2 gap-y-10 md:gap-0 md:flex w-[90%] md:w-full flex-wrap justify-center  text-xs md:text-base text-[#0A0A0A] font-magistral font-normal">
                          ...
                          <Typography variant="body-regular-magistral" className=' md:px-4 px-2'>
                            <Typography variant="body-regular-magistral" as="span"><b className='md:text-xl text-lg md:bg-transparent bg-[#fff8ea] rounded-xl px-2 py-1'>LiFePO4</b><br></br>Battery</Typography>
                          </Typography>
                        </div>
                      </div>
