    ...
    return (
        <div>
            ...
            <Typography variant="subtext-regular-jakarta">
                In line with Crown Electric Mobility’s mission to promote accessible, sustainable transportation across Pakistan,<Typography variant="subtext-semibold-jakarta" as="span">
                    {" Director – Business Development, Mr. Zohaib Farhan, "}
                </Typography> recently visited Crown Electric Mobility’s dealerships in Karachi. Accompanied by Regional Sales Manager Sindh, <Typography variant="subtext-semibold-jakarta" as="span">
                    {"Mr. Mubashir Awan, "}
            ...
            <Typography variant="subtext-semibold-jakarta" className="mt-5 mb-5">
                This visit reflects Crown Electric Mobility’s dedication to expanding its electric vehicle (EV) network and offering urban consumers innovative, eco-friendly mobility solutions. With a growing lineup of electric bikes, the company continues to set benchmarks in electric mobility.
            </Typography>
