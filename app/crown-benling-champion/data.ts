...
export const faqsData = [
    {
        question: "What is the top speed of the electric bike?",
        answer: "The bike can reach a top speed of 65–70 km/h, providing both efficiency and power for urban commuting."
    },
    {
        question: "How far can the bike travel on a single charge?",
        answer: "In ECO mode, the bike offers a range of 200–220 km, making it ideal for long rides and daily use."
    },
    {
        question: "How long does it take to fully charge the battery?",
        answer: "The bike takes approximately 5–6 hours to fully charge using a 72V8A charger."
    },
    {
        question: "What type of battery does the bike use?",
        answer: "It is equipped with a 72V60Ah Lithium LiFePO₄ battery, known for its safety, long life, and stable performance."
    },
        {
        question: "What warranty is provided with the bike?",
        answer: "The battery, motor, and controller come with a 4-year or 48,000 km warranty, while body parts are covered for 12 months or 12,000 km."
    },
];