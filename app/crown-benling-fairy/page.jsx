...
const page = () => {
  ...
  return (
    <div>
      ...
      />
      <Featured stats={statsData} itemsPosition='items-end' mobileImageSrc={FeatureMbl} imageAlt={"RoshniX Featured Image"} imageSrc={FairyFeaturedIMG} textColor="text-black"
