...
export const featureHeader = {
  ...
  export const aboutSpecificationsData = [
    ...
    { title: "Top Speed", value: "50-55 km/h" },
    { title: "Range", value: "100-120 km" },
    { title: "Battery", value: "72V.30Ah" },
...
export const faqsData = [
    {
        question: "What type of battery does the Victory scooter use?",
        answer: "Victory is powered by a 72V 30Ah Lithium battery, known for its durability, lightweight design, and long life cycle."
    },
    {
        question: "How long does it take to fully charge the battery?",
        answer: "Using the included 72V 6A charger, the battery charges fully in approximately 4 to 5 hours."
    },
    {
        question: "Can I remove the battery for charging?",
        answer: "No, the battery is fixed and charges directly on the scooter."
    },
    {
        question: "What tyre size does the Victory scooter have?",
        answer: "The scooter features 3.00-10 tyres on both the front and rear, offering stability and comfort across different terrains."
    },
        {
        question: "What is the motor power of this scooter?",
        answer: "Victory comes equipped with a 1000W high-efficiency motor, offering a balance of power and energy savings."
    },
];